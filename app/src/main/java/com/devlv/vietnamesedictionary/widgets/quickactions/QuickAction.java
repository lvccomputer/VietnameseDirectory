package com.devlv.vietnamesedictionary.widgets.quickactions;
...
//        mArrowUp = (ImageView) mRootView.findViewById(R.id.arrow_up);
    ...
    public void addActionItem(ActionItem action) {
        ...
        if (mOrientation == HORIZONTAL) {
            container = mInflater.inflate(R.layout.item_action_horizontal, null);
        } else {
            container = mInflater.inflate(R.layout.item_action_vertical, null);
        }
        ...
        container.setOnClickListener(v -> {
            if (mItemClickListener != null)
                mItemClickListener.onItemClick(actionId, word,position);
    ...
    public void show(View anchor, Word diaryEntry, int position) {
        this.word = diaryEntry;
        ...
        //calculate position click on screen to show popup
        int dyTop = anchorRect.top;
        int dyBottom = screenHeight - 600;
...
//        hideArrow.setVisibility(View.INVISIBLE);
    ...
    public interface OnActionItemClickListener {
        void onItemClick(int actionId, Word word, int position);
    }
